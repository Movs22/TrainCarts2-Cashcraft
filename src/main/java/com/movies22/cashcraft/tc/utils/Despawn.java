...
public enum Despawn {
   ...
   UNKNOWN_PARENT("despawn.unknown_parent", (String)null),
   ...
   ZOMBIE("despawn.zombie", (String)null),
   ...
   // $FF: synthetic method
   private static Despawn[] $values() {
      return new Despawn[]{INVALID_SECTION, INVALID_ROUTE, UNKNOWN_PARENT, INVALID_NODE, INVALID_HEADING, MISSING_CARTS, EXCEEDED_REROUTING_ATTEMPTS, ILLEGAL_SPEED, BUFFERS_EATEN, ZOMBIE, INVALID_TRAIN, UNKNOWN};
   }
}
