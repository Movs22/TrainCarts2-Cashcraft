...
public class StationAnnouncements {
   public static String convertColor(String name) {
      ...
      if (name.contains("$CHR")) {
         return "#C55A11";
      } else if (name.contains("$GAR")) {
         return "#1BF400";
      } else if (name.contains("$HS1")) {
         return "#00946F";
      } else if (name.contains("$HS2")) {
         return "#00DFFF";
      } else if (name.contains("$SVR")) {
         return "#B955FF";
         ...
         return "#FCE600";
      } else if (name.contains("$NAT")) {
         return "#0075B4";
      } else if (name.contains("$FTrams")) {
         return "#BFAF81";
   ...
   public static String parseMetro(String string, MetroLines.MetroLine l) {
      return parseMetro(string, l, false);
   }

   public static String parseMetro(String string, MetroLines.MetroLine l, Boolean z) {
      ...
      if (string.equalsIgnoreCase("-")) {
         ...
         for(int i = 0; i < string.length(); ++i) {
            if (string.charAt(i) == 'B' && !l.getName().equals("Blue")) {
               ...
               if (string.charAt(i) != 'Y' || l.getName().equals("Yellow")) {
                  if (b == string.length()) {
                     if (!z) {
   ...
   public static String parseRail(String string, MetroLines.MetroLine l, Boolean m) {
      return parseRail(string, l, m, false);
   }

   public static String parseRail(String string, MetroLines.MetroLine l, Boolean m, Boolean z) {
      String color = l.getColour();
      String result;
      if (m && !z) {
      ...
      if (string.equalsIgnoreCase("-")) {
         ...
         for(int i = 0; i < string.length(); ++i) {
            if (string.charAt(i) == '1') {
               ...
               result = result + ", {\"text\":\"Ailsbury Connect\",\"color\":\"" + convertColor("$CHR") + "\"}";
            }
